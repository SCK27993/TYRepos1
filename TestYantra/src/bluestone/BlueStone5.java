...
public class BlueStone5 {
	...
	public static void test() throws Throwable {
		...
		Thread.sleep(1000);
		String ttext = driver.findElement(By.xpath("//header[@class='white-header white-bg']//span[text()='0% Making Charge']")).getText();
		System.out.println(ttext);
		driver.findElement(By.xpath("//header[@class='white-header white-bg']//span[text()='0% Making Charge']")).click();
		Thread.sleep(2000);
		String ptext = driver.findElement(By.xpath("//div[@id='content-column']//span[@class='offer']/span[text()='0% making charge']")).getText();
		System.out.println(ptext);
		String tttext = ttext.toUpperCase();
		System.out.println(tttext);
		if(tttext.equals(ptext)) {
